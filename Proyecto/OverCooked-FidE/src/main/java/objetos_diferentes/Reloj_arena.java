...
public class Reloj_arena extends Objetos_diferentes{
    ...
    public void dibujar (Graphics2D g2){
        ...
        int x_1 = (cj.tamaño_finalObjeto / 3) + 45;
        int y_1 = (cj.tamaño_finalObjeto * 11) - 11;
        int ancho_1 = cj.anchoPantalla - (cj.tamaño_finalObjeto * 18) - 22;
        int largo_1 = cj.tamaño_finalObjeto / 2;
